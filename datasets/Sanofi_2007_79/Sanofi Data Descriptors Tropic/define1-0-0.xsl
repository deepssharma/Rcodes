...
<a class="tocItem" >
 	   <xsl:attribute name="href">#<xsl:value-of select="@SASDatasetName"/></xsl:attribute>
...
<xsl:template name="ItemGroupDef"> 
     ...
     <tr align='left' valign='top'>
	  <td><xsl:value-of select="@SASDatasetName"/></td> 
	  <!-- ************************************************************* -->
  ...
  <!-- ************************************************************* -->  
   <tr>
      ...
      <th colspan='6' align='left' valign='top' height='20' bgcolor="#ECECEC">
         <xsl:value-of select="@def:Label"/> Dataset  (<xsl:value-of select="@SASDatasetName"/>)<br/> 
      </th>
      ...
      <a>
         <xsl:attribute name="Name"><xsl:value-of select="@SASDatasetName"/>
         </xsl:attribute>
      </a>
   </tr>
	...
	<!-- *************************************************** -->
      ...
      <xsl:variable name="ItemgOID" select="@SASDatasetName"/>
      <xsl:for-each select="/odm:ODM/odm:Study/odm:MetaDataVersion/def:ValueListDef">
  ...
  <!-- Get the individual data points -->
      ...
      <tr>
	    ...
	    <!-- Create the target from to link from the data table -->
           ...
           <xsl:if  test="contains($valueDefOid,'LBTESTCD')">
